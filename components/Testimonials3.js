...
const Testimonial = ({ i }) => {
    ...
    return (
        <li key={i}>
            <figure className="relative max-w-lg h-full bg-[#b6bbbb] p-6 md:p-10 bg-base-200 rounded-2xl max-md:text-sm flex flex-col">
                ...
                <figcaption className="relative flex items-center justify-start gap-4 pt-4 mt-4 md:gap-8 md:pt-8 md:mt-8 border-t border-base-content/5">
                    <div className="w-full flex items-center justify-between gap-2">
                        ...
                        <div className="overflow-hidden rounded-full bg-[#888787] bg-base-300 shrink-0">
                            {testimonial.img ? (
                                <Image
